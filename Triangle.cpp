...
Triangle::Triangle(const std::vector<glm::vec3> f_vertices, const std::vector<glm::vec3> f_colors, const std::vector<GLushort> f_indices, GLuint programId)
{
    vertices = f_vertices;
    colors = f_colors;
    indices = f_indices;
...
/*
* Render the triangle from viewpoint view and on plane projection
*/
void Triangle::render(glm::mat4x4& view, glm::mat4x4& projection, cg::GLSLProgram& program)
{
